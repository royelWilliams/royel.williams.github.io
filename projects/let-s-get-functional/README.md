...
## Step 1 - Setup
 ...
 - In your bash terminal run the command `npm link my` with **your** lodown package
...
npm start --prefix ./royel.williams.github.io/projects/
```
...
## Step 2 - Solve
 ...
 - To test your solutions run let-s-get-functional` in your terminal  
